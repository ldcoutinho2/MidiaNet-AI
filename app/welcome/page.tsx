...
export default function Welcome() {
  ...
  return <main className="auth"><div className="authbox" style={{width:"min(900px,100%)"}}>
    ...
    <div className="grid3" style={{marginTop:22}}>
      ...
      <div className="card"><strong>1 estratégia</strong><p className="small muted">geração completa no teste</p></div>
    ...
    <div className="feature" style={{marginTop:18}}>
      <h2>Planos</h2>
      <p className="small muted" style={{marginTop:6}}>O teste não exige pagamento. Depois, você pode continuar por R$ 14,99 por 7 dias ou R$ 29,99 por 30 dias.</p>
      <div className="grid3" style={{marginTop:14}}>
        ...
        <div className="card"><small>7 DIAS · R$ 14,99</small><strong>Semanal</strong><p className="small muted">IA + planejamento + criação + métricas.</p></div>
        <div className="card"><small>30 DIAS · R$ 29,99</small><strong>Mensal</strong><p className="small muted">IA + planejamento + criação + métricas.</p></div>
      </div>
    </div>
  </div></main>;
}
